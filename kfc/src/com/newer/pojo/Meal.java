...
public class Meal {
	...
	public Meal(int id, String mealName, String mealIntroduce,
			String mealPrice, String mealType, int mealAmount, String saleTime,
			String images_path, Set<Order> orders) {
		super();
		this.id = id;
		this.mealName = mealName;
		this.mealIntroduce = mealIntroduce;
	...
	public Meal(String mealName, String mealIntroduce, String mealPrice,
			String mealType, int mealAmount, String saleTime,
			String images_path, Set<Order> orders) {
		super();
		this.mealName = mealName;
		this.mealIntroduce = mealIntroduce;
	...
	public Meal(String mealName, String mealIntroduce, String mealPrice,
			String mealType, int mealAmount, String saleTime, String images_path) {
		super();
		this.mealName = mealName;
		this.mealIntroduce = mealIntroduce;
		this.mealPrice = mealPrice;
	...
	public String toString() {
		...
		return "Meal [id=" + id + ", mealName=" + mealName
				+ ", mealIntroduce=" + mealIntroduce + ", mealPrice="
				+ mealPrice + ", mealType=" + mealType + ", mealAmount="
				+ mealAmount + ", saleTime=" + saleTime + ", images_path="
				+ images_path + "]"+"wo shi meal";
	}
